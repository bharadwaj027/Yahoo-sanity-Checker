 ...
 * Source: 'AC - Native Mobile IDL and EBL - Working Draft.xlsx' (tabs 'native iOS' / 'native Android').
 * Each entry: { platform: 'iOS'|'Android', checkpoint, issueDescription, recommendation }.
 * The recommendation is the sheet's 'Recommendation to fix' (col D) with the RULE: and
 * BACKGROUND: sections removed (HOW TO FIX + REFERENCE only), preserved verbatim otherwise.
 * Authoritative source of truth for the S14 Native recommendation check. Regenerate from the
 * sheet when it changes (see scratchpad generate.ps1). DO NOT hand-edit recommendation text.
 */
const NATIVE_RECOMMENDATIONS =[
    ...
    },
    {
        ...
        "recommendation":  "System.Xml.XmlElement"
    },
    {
        "platform":  "iOS",
        "checkpoint":  "1.3.2.a",
    ...
    },
    {
        ...
        "checkpoint":  "1.1.1.a",
        "issueDescription":  "The image is changing dynamically but the text alternative doesn\u0027t correspond to the active image displayed.",
        "recommendation":  "HOW TO FIX:\nFix this issue by updating the contentDescription property as the ImageView changes. \n\nThe play button changes to a pause button:\n\nUsing Java:\nif (...) {\n            imageObj.setContentDescription(\"Play\");\n        } else {\n            imageObj.setContentDescription(\"Pause\");\n        }\n\nREFERENCE: \nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/images/functional\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.a",
        "issueDescription":  "The text alternative does not serve the same purpose as the image.",
        "recommendation":  "HOW TO FIX:\nFix this issue by implementing the contentDescription property for the active ImageView to describe its destination, purpose, or function.\n\nUse ONE of the following techniques:\n\n1. Using XML:\nandroid:contentDescription=\"ABCD Home\"\n\n2. Using Java:\nimageObj.setContentDescription(\"ABCD Home\");\n\nREFERENCE: \nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/images/functional\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.a",
        "issueDescription":  "The text alternative for the active image is missing.",
        "recommendation":  "HOW TO FIX:\nFix this issue by implementing the contentDescription property for the ImageView to convey the destination, purpose, or function of the image.\n\nUse ONE of the following techniques:\n\n1. Using XML:\nandroid:contentDescription=\"ABCD Home\"\n\n2. Using Java:\nimageObj.setContentDescription(\"ABCD Home\");\n\nREFERENCE: \nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/images/functional\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.a",
        "issueDescription":  "The text alternative does not contain the essential text in the active image, and therefore does not present the same information as the image.",
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that the contentDescription property for the active ImageView, includes all essential text in the image so it accurately describes its destination, purpose, or function.\n\nUse ONE of the following techniques:\n\n1. Using XML:\nandroid:contentDescription=\"ABCD Home\"\n\n2. Using Java:\nimageObj.setContentDescription(\"ABCD Home\");\nREFERENCE: \nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/images/functional\n\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.b",
        "issueDescription":  "The text alternative does not present the same information as the image.",
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that the contentDescription property for the informative image describes its intent, purpose, or meaning.\n\nUse ONE of the following techniques:\n\n1. Using XML:\nandroid:contentDescription=\"The sun setting over the Pacific Ocean, with a silhouette of a flying seagull in the foreground\"\n\n2. Using Java:\nimageObj.setContentDescription(\"The sun setting over the Pacific Ocean, with a silhouette of a flying seagull in the foreground\");\nREFERENCE: \nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/images/informative\n\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.b",
        "issueDescription":  "The image is changing dynamically but the text alternative doesn\u0027t correspond to the informative image displayed.",
        "recommendation":  "HOW TO FIX:\nFix this issue by updating the contentDescription property of the ImageView as the image changes.\n\nUsing Java:\nif (...) {\n            imageObj.setContentDescription(\"Play\");\n        } else {\n            imageObj.setContentDescription(\"Pause\");\n        }\nREFERENCE: \nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/images/informative\n\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.b",
    ...
    },
    {
        ...
        "checkpoint":  "1.1.1.c",
        "issueDescription":  "The complex image is missing both short and detailed text alternatives.",
        "recommendation":  "HOW TO FIX:\nFix this issue by providing both a short text alternative on the image itself and a complete long description. Use the contentDescription property on the ImageView component to convey the intent, purpose, or meaning of the image.\n\nUsing ONE of the following techniques to provide short text alternative:\n1. Using XML:\nandroid:contentDescription=\"Sales results by quarter. The extended description is below the chart\"\n2. Using Java:\nimageObj.setContentDescription(\"Sales results by quarter. The extended description is below the chart\");\n\nAnd using ONE of the following techniques to provide long description:\n1. Provide the long description in the context of the screen itself.\n2. Provide a button that expands a collapsed region that contains the long description.\n3. Provide a button to open a dialog that contains the long description.\n4. Provide a link to a long description on another screen via a normal link text.\n\nREFERENCE: \nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.c",
        "issueDescription":  "The short text alternative for the complex image is not appropriate or meaningful.",
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that the short alternative text for the image gives a meaningful description of the main purpose or content of the image and refers to the location of the long description.\n\nUsing ONE of the following techniques:\n1. Using XML:\nandroid:contentDescription=\"Sales results by quarter. Extended description is below the chart.\"\n2. Using Java:\nimageObj.setContentDescription(\"Sales results by quarter. Extended description is below the chart.\");\n\nREFERENCE: \nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.d",
    ...
    },
    {
        ...
        "checkpoint":  "1.1.1.h",
        "issueDescription":  "The text alternative is not appropriate.",
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that the contentDescription property for the media file object accurately describes the purpose or title of the media content.\n\nUse ONE of the following techniques:\n\n1. Using XML:\nandroid:contentDescription=\"The Audio file about Accessibility Features\"\n\n2. Using Java:\nmediaFileObj.setContentDescription(\"The Audio file about Accessibility Features\");\nREFERENCE: \nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.1.1.h",
        "issueDescription":  "There is no text alternative to describe the media file.",
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that the contentDescription property for the media file object conveys the media purpose or title.\n\nUse ONE of the following techniques:\n\n1. Using XML:\nandroid:contentDescription=\"The Audio file about Accessibility Features\"\n\n2. Using Java:\nmediaFileObj.setContentDescription(\"The Audio file about Accessibility Features\");\n\nREFERENCE: \nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.2.1.a",
    ...
    },
    {
        ...
        "checkpoint":  "1.2.1.a",
        "issueDescription":  "A text transcript is provided but it doesn\u0027t describe all important sound effects.",
        "recommendation":  "HOW TO FIX:\nFix this issue by providing a complete and accurate text transcript for the audio content including all background sounds, sound effects, background music, and other descriptions like a person\u0027s tone.\nREFERENCE:\nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/audio-video/transcripts"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.2.1.a",
        "issueDescription":  "A text transcript is provided but it doesn\u0027t identify all the speakers.",
        "recommendation":  "HOW TO FIX:\nFix this issue by providing a complete and accurate text transcript for the audio content including the identity of each speaker.\nREFERENCE:\nDeque University: \nhttps://dequeuniversity.com/class/mobile-android-techniques/audio-video/transcripts"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.2.1.a",
    ...
    },
    {
        ...
        "checkpoint":  "1.3.1.a",
        "issueDescription":  "Semantic markup has been used inappropriately and misrepresents the meaning, structure, or relationships of the content.",
        "recommendation":  "HOW TO FIX:\nFix this issue by removing incorrect semantic coding to conveys appropriate meaning, structure or relationship of the content.\nREFERENCE: \nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.3.1.a",
    ...
    },
    {
        ...
        "checkpoint":  "1.3.2.a",
        "issueDescription":  "Informative (static) content is not readable by a screen reader.",
        "recommendation":  "HOW TO FIX:\nFix this issue by using the contentDescription property of the static content component to convey the same information of static content.\n\nUse ONE of the following techniques\n\n1. Using XML:\nandroid:contentDescription=\"informative content goes here\"\n\n2. Using Java:\nviewObj.setContentDescription(\"informative content goes here\");REFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/structure/reading-order\n\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:contentDescription"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.3.2.a",
        "issueDescription":  "Content that is intended to be hidden from all users is readable with a screen reader.",
        "recommendation":  "HOW TO FIX:\nFix this issue by removing the element for assistive technology users, implement importantForAccessibility property to hide the content. Use ONE of the following techniques:\n\n1. Using XML:\nandroid:importantForAccessibility=\"no\"\n\n2. Using Java:\nviewObj.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_NO);\nREFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/structure/reading-order\n\nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:importantForAccessibility"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.3.2.a",
    ...
    },
    {
        ...
        "checkpoint":  "1.3.2.a",
        "issueDescription":  "Screen reader focus does not follow visual focus or move to the intended target, such as with a \"return to top\" control.",
        "recommendation":  "HOW TO FIX:\nFix this issue by using the sendAccessibilityEvent to move the screen reader focus to the top of screen:\n\nUsing Java: \ntopNavigationObject?.sendAccessibilityEvent(AccessibilityEvent.TYPE_VIEW_FOCUSED)\nREFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/dialogs/\n\nGoogle:\nhttps://developer.android.com/reference/android/view/accessibility/AccessibilityEvent#TYPE_VIEW_FOCUSED"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.3.2.a",
        "issueDescription":  "Screen reader focus falls on an interactive element that is hidden or empty.",
        "recommendation":  "HOW TO FIX:\nFix this issue by removing the element from assistive technology users experience, implement importantForAccessibility property to hide the content. Use ONE of the following techniques:\n\n1. Using XML:\nandroid:importantForAccessibility=\"no\"\n\n2. Using Java:\nviewObj.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_NO);\n\nOR\n\nHOW TO FIX: \nFix this issue by adding the element from assistive technology users experience, implement importantForAccessibility property to visible the content. Use ONE of the following techniques: \n\n1. Using XML: \nandroid:importantForAccessibility=“yes” \n\n2. Using Java: \nviewObj.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_YES); \nREFERENCE: \nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:importantForAccessibility"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.3.2.a",
    ...
    },
    {
        ...
        "checkpoint":  "1.3.4.a",
        "issueDescription":  "The presentation of the content adjusts when the device\u0027s display orientation changes, but some functionality or content is inaccessible.",
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that all the functionality or content is accessible to a particular display orientation. This can be accomplished by ensuring screenOrientation as fullSensor.\n\nUse ONE of the following techniques\n\n1. Using XML:\n\u003cactivity android:name=\".MainActivity\"\n          android:screenOrientation=\"fullSensor\"\u003e\n\u003c/activity\u003e         \n\n2. Using Java:\nYou can call the setRequestedOrientation() method in the onCreate() method of the Activity or at any other appropriate place in your code:\n        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);\n\nREFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/device-orientation\n\nGoogle:\nhttps://developer.android.com/guide/topics/manifest/activity-element.html#screen"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.4.1.a",
    ...
    },
    {
        ...
        "recommendation":  "HOW TO FIX:\nFix this issue by adjusting the large placeholder text color and/or background color to increase the contrast to at least 3 to 1.\n\nREFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/color-contrast/text-contrast"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.4.4.a",
    ...
    },
    {
        ...
        "checkpoint":  "1.4.11.a",
        "issueDescription":  "The visual boundary of an active user interface component lacks 3 to 1 contrast ratio.",
        "recommendation":  "HOW TO FIX:\nFix this issue by adjusting the user interface component boundary and/or background color to increase the contrast with either the inner or outer adjacent background to at least 3 to 1.\n\nREFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/color-contrast/non-text-contrast"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.4.11.b",
        "issueDescription":  "The state of an active component lacks 3 to 1 contrast ratio.",
        "recommendation":  "HOW TO FIX:\nFix this issue by adjusting the state indicator (e.g. selected, checked etc) color of the user interface component and/or background color, to increase the contrast to at least 3 to 1.\n\nREFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/color-contrast/non-text-contrast"
    },
    {
        "platform":  "Android",
        "checkpoint":  "1.4.11.b",
    ...
    },
    {
        ...
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring the time extension option is Switch Access accessible.\n\nUsing Java:\n view.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_YES);\n view.setContentDescription(\"Extend\");\n view.setOnClickListener(new View.OnClickListener() {\n                @Override\n                public void onClick(View v) {\n                ...    \n                }\n            });\n\nREFERENCE: \nGoogle:\nhttps://developer.android.com/reference/android/view/View.html#attr_android:importantForAccessibility"
    },
    {
        "platform":  "Android",
        "checkpoint":  "2.2.2.a",
    ...
    },
    {
        ...
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that focus is not moved to another component or removed altogether when a component receives Switch Access focus."
    },
    {
        "platform":  "Android",
        "checkpoint":  "3.2.1.a",
    ...
    },
    {
        ...
        "checkpoint":  "3.2.4.a",
        "issueDescription":  "Components are labeled differently on different pages or screens, though they have the same function.",
        "recommendation":  "HOW TO FIX:\nFix this issue by ensuring that components that have the same functionality across multiple screens are labelled consistently. This requirement extends to both visible labels and non-visible labels (such as an contentDescription used on an icon or button)."
    },
    {
        "platform":  "Android",
        "checkpoint":  "3.2.6.a",
    ...
    },
    {
        ...
        "checkpoint":  "3.3.2.a",
        "issueDescription":  "No visual label is present and the purpose of this field is not clear without a visual label.",
        "recommendation":  "HOW TO FIX:\nFix this issue by using ONE of the following techniques, to ensure that the form field has a visible label and it is always visible:\n\n1. Ensure that the form field is programmatically associated with the label e.g. via the labelFor property.\n2. Ensure that the form field is implemented using TextInputLayout and programmatically associated with the visible label e.g. via the hint property.\n\nREFERENCE: \nDeque University:\nhttps://dequeuniversity.com/class/mobile-android-techniques/forms/labels"
    },
    {
        "platform":  "Android",
        "checkpoint":  "3.3.2.a",
